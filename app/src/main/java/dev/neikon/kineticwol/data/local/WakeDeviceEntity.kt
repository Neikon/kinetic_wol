...
data class WakeDeviceEntity(
    ...
    @ColumnInfo(name = "shutdown_ssh_public_key") val shutdownSshPublicKey: String?,
                ...
                ssh =
                    if (
                        ...
                        SshShutdownConfig(
                            ...
                            publicKey = shutdownSshPublicKey.orEmpty(),
...
fun WakeDevice.toEntity(): WakeDeviceEntity =
    WakeDeviceEntity(
        ...
        shutdownSshPublicKey = remoteShutdown.ssh?.publicKey,
