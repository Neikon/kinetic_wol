...
- Se añadió `docs/ssh_linux_shutdown.md` como guía paso a paso para preparar apagado remoto por SSH en Linux y se enlazó desde el README
- Se añadió `docs/truenas_scale_ssh_shutdown.md` como guía paso a paso para preparar apagado remoto por SSH en TrueNAS SCALE desde la Web UI y se enlazó desde el README
